...
import { isoDate } from './occurrence'
...
// Reading "plan the group report due monday, 4 hours" out of a spoken memo.
//
// ponytail: the same rules live in bot/src/plan-parse.ts. Duplicated on purpose,
// like detect.ts — the bot has to understand you with the app closed, and the
// app has to understand you with the bot off.
//
